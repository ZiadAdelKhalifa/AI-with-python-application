...
from utils import chatgpt,diffusion,translate_keywords,transcribe_function,modify_gpt
import os
import tempfile
app = Flask(__name__)
...
def transcribe_api():
    ...
    with tempfile.NamedTemporaryFile(suffix=file_extension,delete=False) as temp_file:
        ...
        trascription=transcribe_function(temp_path)
        temp_file.close()
    os.remove(temp_path)
    return trascription
